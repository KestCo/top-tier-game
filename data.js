  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: ["Exact", "Casual", "Loud", "Recent"],
        answer: "Exact",
        explanation: "Exact means accurate, careful, or precise.",
        editorNotes: "Clean vocabulary with nearby distractors avoided.",
      },
      {
        number: 4,
        tier: 2,
      ...
      },
      {
        ...
        tier: 4,
        type: "Compound Pair",
        prompt: "Which word can follow both book and water to make common words?",
        choices: ["Mark", "Light", "Table", "Line"],
        answer: "Mark",
        explanation: "Bookmark and watermark are both common words.",
        editorNotes: "Strong compound-word clue.",
      },
      {
        number: 11,
        tier: 4,
