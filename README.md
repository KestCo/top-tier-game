...
For shared draft saving, create the Supabase table in `supabase-schema.sql`. The live app reuses `studio-analytics-config.js` for the Supabase URL and publishable key.
